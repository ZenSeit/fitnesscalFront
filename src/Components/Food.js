...
export default function Food({ id, name, quantity, day, description, updateFood, delButton, clickDiv,getData,Button1,Button2}) {
  ...
  return (
    <div className="food--container" onClick={()=>clickDiv(id)}>
      ...
      <div className="food--info">
        ...
        <div>
        <But1 id={id} getData={getData} updateFood={updateFood} day={day} />
